...
#define SYSMON_VERSION_MINOR 9
#define SYSMON_VERSION_PATCH 0
#define SYSMON_VERSION_BUILD 0

#define SYSMON_VERSION_COMMA 0,9,0,0
#define SYSMON_VERSION_STRING "0.9.0"
#define SYSMON_VERSION_DISPLAY "v0.9.0"
#define SYSMON_VERSION_WSTRING L"0.9.0"
#define SYSMON_USER_AGENT_WSTRING L"SysMon/0.9.0"
