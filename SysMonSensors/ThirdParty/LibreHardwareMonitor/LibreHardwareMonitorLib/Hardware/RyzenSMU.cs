...
internal class RyzenSMU
{
    ...
    private readonly Dictionary<uint, Dictionary<uint, SmuSensorType>> _supportedPmTableVersions = new()
    {
        ...
        },
        {
         ...
         {
            // Zen 4 Raphael - PM table 0x00540104.
            0x00540104, new Dictionary<uint, SmuSensorType>
            {
                { 309, new SmuSensorType { Name = "Core #1", Type = SensorType.Temperature, Scale = 1 } },
                { 310, new SmuSensorType { Name = "Core #2", Type = SensorType.Temperature, Scale = 1 } },
                { 311, new SmuSensorType { Name = "Core #3", Type = SensorType.Temperature, Scale = 1 } },
                { 312, new SmuSensorType { Name = "Core #4", Type = SensorType.Temperature, Scale = 1 } },
                { 313, new SmuSensorType { Name = "Core #5", Type = SensorType.Temperature, Scale = 1 } },
                { 314, new SmuSensorType { Name = "Core #6", Type = SensorType.Temperature, Scale = 1 } },
                { 315, new SmuSensorType { Name = "Core #7", Type = SensorType.Temperature, Scale = 1 } },
                { 316, new SmuSensorType { Name = "Core #8", Type = SensorType.Temperature, Scale = 1 } }
            }
         }
    };
